...
<html lang="es">
    ...
    <body>
        ...
        <nav class="navbar">
            <div class="nav-content">
                ...
                <ul class="menu">
                    ...
                    <li><a href="Controlador?menu=conocenosCliente">NOSOTROS</a></li>
                    <li><a href="Controlador?menu=vistaproductoCliente">TIENDA</a></li>
                    <li><a href="Controlador?menu=mispedidosClientes">MIS PEDIDOS</a></li>
                </ul>
                <div class="iconos">
                    <a href="#"><i class="fa fa-search"></i></a>
                    <a href="Controlador?menu=mispedidosClientes"><i class="fa fa-shopping-cart"></i></a>
                    <a href="Controlador?menu=VistaUsuarioClienteC&id=${sessionScope.codigoUsuario}" class="logo-usuario">
                        <img src="${pageContext.request.contextPath}/MostrarImagen?id=${sessionScope.codigoUsuario}" alt="Usuario" />
                    </a>
                </div>
            </div>
        </nav>
        ...
        <section class="ofertas-destacadas">
            <div class="oferta">
                ...
                <div class="oferta-info">
                    ...
                    <a href="Controlador?menu=vistaproductoCliente" class="btn-oferta">COMPRAR AHORA</a>
                </div>
            </div>
            <div class="oferta">
        ...
        <section id="NuevosProductos" class="nuevos-productos-titulo">
            ...
            <a href="Controlador?menu=vistaproductoCliente" class="btn-ver-todo">VER TODO</a>
        </section>
