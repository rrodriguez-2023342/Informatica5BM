                ...
                <div class="section">
                    ...
                    <form action="Controlador?menu=Proveedor" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <input type="text" class="entrada_texto" name="txtDireccionProveedor" id="txtDireccionProveedor" value="${proveedor.getDireccionProveedor()}" required>
                                <label class="label-input">Direccion Proveedor</label>
                            </div>
                                        ...
                                        <td>
                                            <div class="botonesTabla">
                                                <button type="button" class="btn_editar" name="btnEditarProveedor" id="btnEditarProveedor"
                                                        onclick="window.location.href = 'Controlador?menu=Proveedor&accion=Editar&id=${proveedor.getCodigoProveedor()}'">
